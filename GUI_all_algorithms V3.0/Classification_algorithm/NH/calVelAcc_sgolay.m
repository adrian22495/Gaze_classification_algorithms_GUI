...
ETparams.data(i,j).vel(1:ceil(F/2)) = ETparams.data(i,j).vel(ceil(F/2));
ETparams.data(i,j).vel(end-ceil(F/2):end) = ETparams.data(i,j).vel(end-ceil(F/2));
...
ETparams.data(i,j).acc(1:ceil(F/2)) = ETparams.data(i,j).acc(ceil(F/2));
ETparams.data(i,j).acc(end-ceil(F/2):end) = ETparams.data(i,j).acc(end-ceil(F/2));
